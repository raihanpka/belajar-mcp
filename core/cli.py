...
# Pilih agent berdasarkan ENV
AI_PROVIDER = os.getenv("AI_PROVIDER", "claude").lower()

if AI_PROVIDER == "openai":
    from core.gpt_cli_chat import CliChatGPT as BaseCliChat
else:
    from core.claude_cli_chat import CliChat as BaseCliChat
...
class CliApp:
    def __init__(self, agent: BaseCliChat):
        self.agent = agent
        self.resources = []
        self.prompts = []
